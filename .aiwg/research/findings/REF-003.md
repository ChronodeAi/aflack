...
tags: [data-sources, benchmarking, tiktok, analytics, indexers]
status: quality-assessed
citations: ["REF-001", "REF-004"]
quality_assessment:
  grade: moderate
...
- **REF-001** -- Long-term memory system: where benchmarking results are stored and queried.
- **REF-004** -- Viral creator playbooks: the operator-level strategies this benchmarking layer validates against.
