...
tools: ["ApplyPatch","Create","Edit","Execute","FetchUrl","Read","Task","TodoWrite","WebSearch"]
---
...
## Non-Functional Requirements
- HIPAA-compliant audit logging; login completes within 3s; SSO via SAML 2.0
```

Domain-specific terms (NPI, HIPAA, SAML), testable criteria, realistic security.

> Moderate (multi-step checkout use case) and complex (trading-platform NFR analysis)
> worked examples: see `docs/agent-examples/requirements-analyst-examples.md`
> (`aiwg discover "requirements analyst worked examples"`).
