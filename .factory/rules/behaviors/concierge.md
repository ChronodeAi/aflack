...
# AIWG Behavior: concierge

Provider surface: Factory rules
Provider: factory
Native source: ../my-aiwg/agentic/code/behaviors/concierge/BEHAVIOR.md

'Persistent front-facing interface for the AIWG daemon. Routes user requests
